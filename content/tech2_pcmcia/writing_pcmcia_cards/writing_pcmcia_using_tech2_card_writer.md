...
*   [PCMCIA card bin files](/content/tech2_pcmcia/available_tech2_.bin-files/) for Tech2
...
Select the binary file you wish to write to the PCMCIA card inserted into the Tech2.
